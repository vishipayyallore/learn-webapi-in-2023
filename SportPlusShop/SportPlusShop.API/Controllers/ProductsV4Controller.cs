...
[Route("api/products")]
[ApiController]
public class ProductsV4Controller : ControllerBase
{
    private readonly SportsShopDbContext _sportsShopDbContext;

    public ProductsV4Controller(SportsShopDbContext sportsShopDbContext)
    {
    ...
    {
        IQueryable<Product> products = _sportsShopDbContext.Products.Where(p => !p.IsAvailable);
